...
|---|---|---|---|---|
| 1 | OOP review and Scanner | `MenuItem`, `FoodItem`, `Beverage`: private fields and getters, `FileStorage.load`: reads the files with `Scanner` | `MenuItemTest`, `FileStorageTest` | |
